...
<script>
    ...
    export default {
        ...
        jisuan1(){
            ...
            if(!this.value1){
                ...
                getResult('post','/repay/v1/repay/calc_repayable',{
                    loanId:this.getId,
                    repayDate:this.value1.getFullYear() +'-'+ (this.value1.getMonth() + 1) +'-'+ this.value1.getDate()
                })
                .then(data=>{
                    if(data.result == 0){
        ...
        mounted(){
            ...
            this.$refs.myuser.style.minHeight = window.innerHeight - 175 + 'px'
