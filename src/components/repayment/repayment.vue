        ...
        <div class="content" ref="myuser">
            ...
            <div class="list">
                ...
                <div class="list-table">
                    ...
                    <p class="detail">
                        <span>订单编号: {{applyNomber}}</span>
                        <span>结算时间: {{day}}</span>
                        <span>借款金额: {{repayMoney}}</span>
                    </p>
                    <table cellspacing="0">
                        <thead>
                            <th>订单编号</th>
        ...
        mounted(){
            ...
            .then(data=>{
                if(data.result == 0){
                    ...
                    this.applyNomber = data.data.applyNo
                    if(data.data.repayDate !=null){
                        this.day = timestampToTime(data.data.repayDate)
                    }
                    if(data.data.loanAmt != null){
                        this.repayMoney = toThousands(data.data.loanAmt)
                    }
