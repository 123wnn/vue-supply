        ...
        <div class="user-set">
            ...
            <div v-if="myIndex===0" class="right">
                ...
                <div v-if="youIndex===0" class="r-bottom">
                    <div class="msg">
                        <div class="name">联系人手机号</div>
                        <div class="cont" v-if="!inputShow">{{userPhone}}</div>
                        <input v-if="inputShow" v-model="userPhone" type="text" placeholder="请输入手机号"/>
                    </div>
                    <div class="msg">
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            this.$refs.myuser.style.minHeight = window.innerHeight - 165 + 'px'
