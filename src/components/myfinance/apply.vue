    ...
    <div class="apply">
        ...
        <div ref="myuser1" class="content" v-if="!successShow">
            ...
            <div class="upLoad" v-if="myIndex == 1">
                ...
                <ul>
                    <li v-for="(file,index) in dataYouPinArr1">
                        <div class="file-top">
                            <div class="left">
                                <img src="./img/file.png"/><span>{{file.fileName}}</span>
                            </div>
                            <img class="right" src="./img/delete.png" @click="deleteYouPin1(file,index)"/>
                        </div>
                ...
                <ul>
                    <li v-for="(file,index) in dataYouPinArr2">
                        <div class="file-top">
                            <div class="left">
                                <img src="./img/file.png"/><span>{{file.fileName}}</span>
                            </div>
                            <img class="right" src="./img/delete.png" @click="deleteYouPin2(file,index)"/>
                        </div>
                        <div class="file-bottom">
                            <p class="ccc"></p>
                            <p class="blue"></p>
            ...
            <div class="upLoad" v-if="myIndex == 2">
                ...
                <ul>
                    <li v-for="(file,index) in dataShopArr1">
                        <div class="file-top">
                            <div class="left">
                                <img src="./img/file.png"/><span>{{file.fileName}}</span>
                            </div>
                            <img class="right" src="./img/delete.png" @click="deleteShop1(file,index)"/>
                        </div>
                        <div class="file-bottom">
                            <p class="ccc"></p>
                            <p class="blue"></p>
                ...
                <ul>
                    <li v-for="(file,index) in dataShopArr2">
                        <div class="file-top">
                            <div class="left">
                                <img src="./img/file.png"/><span>{{file.fileName}}</span>
                            </div>
                            <img class="right" src="./img/delete.png" @click="deleteShop2(file,index)"/>
                        </div>
                        <div class="file-bottom">
                            <p class="ccc"></p>
                            <p class="blue"></p>
        ...
        methods:{
            ...
            fileYouPin1(event){
                ...
                getResult('post','/basics/v1/upload',param,config)
                    .then(data=>{
                        ...
                        this.dataYouPinArr1.push({
                            fileName: fileName,
                            filePath: data.data.filePath,
                            realPath: `${hostUrl + data.data.filePath}`
                        });

                        this.feedbackImg1 = JSON.stringify(this.dataYouPinArr1)
            ...
            fileYouPin2(event){
                ...
                getResult('post','/basics/v1/upload',param,config)
                    .then(data=>{
                        console.log(data.data)
                        this.dataYouPinArr2.push({
                            fileName: fileName,
                            filePath: data.data.filePath,
                            realPath: `${hostUrl + data.data.filePath}`
                        });
                        this.feedbackImg2 = JSON.stringify(this.dataYouPinArr2)
                        console.log('feedbackImg')
            ...
            deleteYouPin1(file,index){
                this.dataYouPinArr1.splice(index,1)
                console.log(this.dataYouPinArr1)
            },
            deleteYouPin2(file,index){
                this.dataYouPinArr2.splice(index,1)
                console.log(this.dataYouPinArr2)
            },
            youPin(){
                if(!this.money){
                    Toast('请填写申请融资金额')
            ...
            fileShop1(event){
                ...
                getResult('post','/basics/v1/upload',param,config)
                    .then(data=>{
                        console.log(data.data)
                        this.dataShopArr1.push({
                            fileName: fileName,
                            filePath: data.data.filePath,
                            realPath: `${hostUrl + data.data.filePath}`
                        })
                        this.ShopImg1 = JSON.stringify(this.dataShopArr1)
                        console.log('feedbackImg')
            ...
            fileShop2(event){
                ...
                getResult('post','/basics/v1/upload',param,config)
                    .then(data=>{
                        console.log(data.data)
                        this.dataShopArr2.push({
                            fileName: fileName,
                            filePath: data.data.filePath,
                            realPath: `${hostUrl + data.data.filePath}`
                        })
                        this.ShopImg2 = JSON.stringify(this.dataShopArr2)
                        console.log('feedbackImg')
            ...
            deleteShop1(file,index){
                this.dataShopArr.splice(index,1)
            },
            deleteShop2(file,index){
                this.dataShopArr.splice(index,1)
            },
            shop(){
                if(!this.money){
